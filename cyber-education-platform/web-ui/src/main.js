...
const API_URL = `${process.env.CYBER_EDUCATION_API_BASE_URL}/api`;
// const VNC_URL =
//   'http://localhost:6080/vnc.html?autoconnect=1&resize=scale&quality=9&compression=2&password=kali123';
const VNC_URL = `${process.env.CYBER_EDUCATION_VNC_BASE_URL}/vnc.html?autoconnect=1&resize=scale&quality=9&compression=2&password=kali123`
